...
class Tests extends FreeSpec with PropertyChecks with Matchers
{
	...
	val db = Connection.mem()
		...
		db.root.set( "e" -> "zxcvzxcvzxcv" )
		db.root.get shouldBe Map( "a" -> List(1, 2, 3), "bb" -> 234, "c" -> "qwerqwerqwer", "e" -> "zxcvzxcvzxcv" )
		
		db.root.set( "d" -> 5678 )
		db.root.get shouldBe Map( "a" -> List(1, 2, 3), "bb" -> 234, "c" -> "qwerqwerqwer", "d" -> 5678, "e" -> "zxcvzxcvzxcv" )
